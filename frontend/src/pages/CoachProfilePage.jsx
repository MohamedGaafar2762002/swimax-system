    ...
    <div className="animate-fade-in space-y-8">
      ...
      <div className="card-float overflow-hidden p-0">
        <div className="border-b border-sky-500/10 bg-gradient-to-r from-sky-500/10 via-transparent to-cyan-500/10 px-8 py-6">
          <p className="text-xs font-semibold uppercase tracking-[0.2em] text-sky-300/90">SWIMAX · Coach</p>
          <h1 className="mt-2 text-2xl font-semibold text-white md:text-3xl">{coach.name}</h1>
        </div>
        ...
        <div className="flex flex-col gap-6 p-8 md:grid md:grid-cols-[260px_minmax(0,1fr)] md:items-stretch">
          ...
          <div className="flex h-full flex-col gap-4">
            ...
            <div className="profile-stat">
              ...
              <p className="mt-2 text-lg font-medium text-white">{coach.name}</p>
            </div>

            <div className="profile-stat">
              <p className="text-xs font-semibold uppercase tracking-wider text-slate-500">Age</p>
              <p className="mt-2 text-lg font-medium text-white">{coach.age}</p>
            </div>
            ...
            <div className="profile-stat">
              <p className="text-xs font-semibold uppercase tracking-wider text-slate-500">Record created</p>
              <p className="mt-2 text-slate-300">
                {coach.createdAt ? new Date(coach.createdAt).toLocaleString() : "—"}
              </p>
            </div>
            </div>
          </div>
